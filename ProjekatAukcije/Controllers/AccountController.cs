...
namespace ProjekatAukcije.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Edit(EditViewModel model)
        {
            ...
            string userId = User.Identity.GetUserId();
            User oldUser = db.User.Where(u => u.idAspNetUsers == userId).FirstOrDefault();


            if (oldUser != null)
            {
              //  User newUser = db.User.Where(u => u.Id == oldUser.Id).FirstOrDefault();
                User otherUser = db.User.Where(u => u.Email == model.Email).FirstOrDefault();
                if (otherUser!=null && otherUser.Id != oldUser.Id) return View(model);
        ...
        //
        // GET: /Account/NewAuction
        public ActionResult NewAuction()
        {
            return View();
        }
        //
        // POST: /Account/NewAuction
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            {
                case SignInStatus.Success:
                    return /*RedirectToAction("UserIndex", "Auction")*/RedirectToLocal(model.ReturnUrl);
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.Failure:
                default:
